...
function searchDoc(doc,num){
var queryIndexF1='select * from html where url="http://www.evapharma.com/ar/doctors/?search=name&name='+doc+'&gender=0&PageNo='+num+'" and xpath="//*[@id=\'Serach_Results\']"';
